...
class HomeController extends BaseController {
    ...
    public function detail($page)
    {
        ...
        if($page < 1) {
            return Redirect::to('home/detail/' . 1);
        }

        if($page > $totalPage) {
            return Redirect::to('home/detail/' . $totalPage . '?' . implode(array('title=' . $inputTitle)));
        }

        return $this->layout->main = View::make('home.list-detail',
            array('detail'     => $data,
    ...
    public function deleteDetail($detailId)
    {
        ...
        if ($detail) {
            ...
            if($detail->delete()) {
                return Redirect::to('home/detail')->withSuccess('Your detail was deleted with success.');
            }
        }
        ...
        if (Request::isMethod('post')) {
            ...
            if ($vParams) {
                ...
                if (!$falseImage) {
                    ...
                    if ($result) {
                        return Redirect::to('home/createDetail')->withSuccess('Your detail was added with success.');
                    }
                }
            }
            ...
            if ($errors) {
                return Redirect::to('home/createDetail')->withErrors($errors)->withInput();
            }

            return Redirect::to('home/createDetail');
        }

        return $this->layout->main = View::make('home.create-detail');
    }
    ...
    public function editDetail($detailId)
    {
            ...
            if (Request::isMethod('post')) {
                ...
                if ($vParams) {
                    ...
                    if (!$falseImage) {
                        ...
                        if ($result) {
                            return Redirect::to('home/editDetail/' . $detailId)
                ...
                if ($errors) {
                    return Redirect::to('home/editDetail/' . $detailId)->withErrors($errors)->withInput();
                }

                return Redirect::to('home/editDetail/' . $detailId);
            }

            return $this->layout->main = View::make('home.edit-detail')
                ->with('detail', $detail)
        ...
        return Redirect::to('home/detail')->withSuccess('Your detail was not found.');
    }
...
//        $file->move(DetailImage::getPathDetailImage(), $fileName);
    ...
    public function popupAddCategory()
    {
        ...
        return $this->layout->main = View::make('home.popup.add-category')
    ...
    public function popupAddRoad()
    {
        ...
        return $this->layout->main = View::make('home.popup.add-road')
